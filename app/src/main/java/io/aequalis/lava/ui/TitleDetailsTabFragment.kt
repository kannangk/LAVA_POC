...
class TitleDetailsTabFragment : Fragment() {
    ...
    companion object {
        fun newInstance(resObj: JSONObject,titleId:String): TitleDetailsTabFragment {
            val resultsTabFragment = TitleDetailsTabFragment()
            resultsTabFragment.resObj = resObj
            resultsTabFragment.titleId = titleId
    ...
    override fun onCreateView(
        ...
        collapsingToolbar.title = "Title View "+titleId
        viewPager!!.offscreenPageLimit = 2
        adapter = LavaViewPageAdapter(childFragmentManager)
        adapter!!.add(TitleDetailsFragment.newInstance(resObj!!))
